...
/*Omar: Statement will be an abstract class.
All the different instruction opcodes will inherit from it.
Thus we should have a derived class for every opcode.
The following are the opcodes we need to be able to read:
